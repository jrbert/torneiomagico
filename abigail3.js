...
if (inicio == 1) {
    ...
    alert (" Você se torna o mestre de Karsus, levando ele diretamente para uma prisão de Bruxos. A população de Ravaryn decide que você merece ser Campeã do torneio. Você venceu. FIM DE JOGO.")
    break;
}
else if (inicio == 3){
